...
def main():
    ...
    y_train=(sc.textFile("y_to_train.txt").lambda(to_unicode))
        
    X_test=(sc.textFile("X_to_test.txt").lambda(to_unicode))
    y_test=(sc.textFile("y_to_test.txt").lambda(to_unicode))
